...
const GameCarousel: React.FC<GameCarouselProps> = ({ games, cardVariant = 'default' }) => {
  ...
  // Compact width calculations for high density "Steam-like" feel
  // Shows approx: 2 on mobile, 3 on sm, 4 on md, 5 on lg, 6 on xl
  const cardWidthClass = cardVariant === 'vertical' 
    ? "w-[40%] sm:w-[28%] md:w-[22%] lg:w-[16.66%]" 
    : "w-[60%] sm:w-[33%] md:w-[24%] lg:w-[19%] xl:w-[15.5%]"; 
  ...
  return (
    <div className="relative group">
      ...
      <div
        ...
        // Reduced vertical padding to match compact style
        className="flex overflow-x-auto snap-x snap-mandatory scroll-smooth gap-4 py-6 -my-6 no-scrollbar items-stretch px-2 md:px-0"
