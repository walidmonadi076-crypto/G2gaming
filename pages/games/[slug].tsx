...
const GameDetailPage: React.FC<GameDetailPageProps> = ({ game, similarGames }) => {
    ...
    if (router.isFallback) return <div className="min-h-screen bg-[#0d0d0d] flex items-center justify-center text-white font-fredoka uppercase">Loading Terminal...</div>;
